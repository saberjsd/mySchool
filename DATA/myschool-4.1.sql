...
-- 正在导出表  myschool.collection 的数据：~1 rows (大约)
...
-- 正在导出表  myschool.comment 的数据：~2 rows (大约)
DELETE FROM `comment`;
...
-- 正在导出表  myschool.course 的数据：~3 rows (大约)
DELETE FROM `course`;
...
-- 正在导出表  myschool.courseitem 的数据：~1 rows (大约)
...
INSERT INTO `courseitem` (`id`, `pid`, `title`, `content`, `status`, `order`) VALUES
	(13, 1, '课程介绍', '/upload/video/2018040319314010757.mp4', 1, 1),
	(14, 1, '移动web开发-1综述', '/upload/video/2018040319314010757.mp4', 1, 2),
	(15, 1, '移动web开发-2常见适配方法', '/upload/video/2018040319314010757.mp4', 1, 3),
	(16, 1, '移动web开发-3MediaQuery', '/upload/video/2018040319314010757.mp4', 1, 4),
	(17, 1, 'rem原理与简介', '/upload/video/2018040319314010757.mp4', 1, 5),
	(18, 1, 'rem页面适配实战', '/upload/video/2018040319314010757.mp4', 1, 6),
	(19, 1, '课程总结', '/upload/video/2018040319314010757.mp4', 1, 7),
	(20, 2, '课程简介', '/upload/video/2018040319314010757.mp4', 1, 1),
	(21, 2, '文档流', '/upload/video/2018040319314010757.mp4', 1, 2),
	(22, 2, 'position-relative', '/upload/video/2018040319314010757.mp4', 1, 3),
	(23, 2, 'position-absolute', '/upload/video/2018040319314010757.mp4', 1, 4),
	(24, 2, 'position-fiexed', '/upload/video/2018040319314010757.mp4', 1, 5),
	(25, 2, 'position-inherit', '/upload/video/2018040319314010757.mp4', 1, 6),
	(26, 2, 'z-index', '/upload/video/2018040319314010757.mp4', 1, 7),
	(27, 2, '定位和边距的区别', '/upload/video/2018040319314010757.mp4', 1, 8),
	(28, 2, '侧边栏导航跟随案例', '/upload/video/2018040319314010757.mp4', 1, 9),
	(29, 3, '课程简介及游戏原理介绍', '/upload/video/2018040319314010757.mp4', 1, 1),
	(30, 3, '界面搭建', '/upload/video/2018040319314010757.mp4', 1, 2),
	(31, 3, '解密那渲染逻辑', '/upload/video/2018040319314010757.mp4', 1, 3),
	(32, 3, '代码结构调整', '/upload/video/2018040319314010757.mp4', 1, 4),
	(33, 3, '键盘控制方块下移', '/upload/video/2018040319314010757.mp4', 1, 5),
	(34, 3, '实现七种方块', '/upload/video/2018040319314010757.mp4', 1, 6),
	(35, 3, '方块固定、消行、游戏结束判定', '/upload/video/2018040319314010757.mp4', 1, 7),
	(36, 3, '增加干扰功能', '/upload/video/2018040319314010757.mp4', 1, 8),
	(37, 3, '对方操作示意', '/upload/video/2018040319314010757.mp4', 1, 9),
	(38, 3, '总结', '/upload/video/2018040319314010757.mp4', 1, 10),
	(39, 4, '环境搭建', '/upload/video/2018040319314010757.mp4', 1, 1),
	(40, 4, '介绍nodejs、npm', '/upload/video/2018040319314010757.mp4', 1, 2),
	(41, 4, '项目安装', '/upload/video/2018040319314010757.mp4', 1, 3),
	(42, 4, '解决问题+结语', '/upload/video/2018040319314010757.mp4', 1, 4),
	(43, 4, '图片与css', '/upload/video/2018040319314010757.mp4', 1, 5),
	(44, 4, '图片分类', '/upload/video/2018040319314010757.mp4', 1, 6),
	(45, 4, '图片的加载方式', '/upload/video/2018040319314010757.mp4', 1, 7),
	(46, 4, 'CSSSprites', '/upload/video/2018040319314010757.mp4', 1, 8),
	(47, 4, '视频播放器简介', '/upload/video/2018040319314010757.mp4', 1, 9),
	(48, 4, 'js前置', '/upload/video/2018040319314010757.mp4', 1, 10),
	(49, 4, '资源提前', '/upload/video/2018040319314010757.mp4', 1, 11),
	(50, 4, '简介技术选型', '/upload/video/2018040319314010757.mp4', 1, 12),
	(51, 4, 'sessionStorage', '/upload/video/2018040319314010757.mp4', 1, 13),
	(52, 4, 'cookie', '/upload/video/2018040319314010757.mp4', 1, 14),
	(53, 4, 'localStorage', '/upload/video/2018040319314010757.mp4', 1, 15),
	(54, 4, 'SDK功能简介', '/upload/video/2018040319314010757.mp4', 1, 16),
	(55, 4, '网络功能拆解', '/upload/video/2018040319314010757.mp4', 1, 17),
	(56, 4, '网络请求', '/upload/video/2018040319314010757.mp4', 1, 18),
	(57, 4, '本地存储模块', '/upload/video/2018040319314010757.mp4', 1, 19),
	(58, 4, 'Ie开头', '/upload/video/2018040319314010757.mp4', 1, 20),
	...
	(64, 5, '课程介绍', '/upload/video/2018040319314010757.mp4', 1, 1),
	(65, 5, '环境搭建', '/upload/video/2018040319314010757.mp4', 1, 2),
	(66, 5, '常量', '/upload/video/2018040319314010757.mp4', 1, 3);
...
-- 正在导出表  myschool.userinfo 的数据：~10 rows (大约)
